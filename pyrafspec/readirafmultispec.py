...
History:
modifed by Jiao Li based on https://github.com/kgullikson88/General/blob/master/readmultispec.py
Created by Rick White based on his IDL readechelle.pro, 2012 August 15
